...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;';
document.querySelector('.Description .modal-body').innerHTML = 'I love you Chịch chịch chịch <i class="fas fa-heart"></i> ';
